...
Security researcher specializing in **Solidity, DeFi protocols, and EVM security**.
...
| ---------- | -------------------------------- | ----------------- | --------- | ------------------ | ----------------------------- |
| 2026 (May) | Stumb The AI Auditor Challange   | Lending           | 4th       | CertiK             | Recognized for the sharpest reasearch feedback of anyone [X Post](https://x.com/certik/status/2057216583303389523) |
...
| 2026 (Feb) | InjectivePeggyBridge             | Bridge            |           | Code4rena          | Judging phase|
| 2026 (Jan) | OpenCover                        | Insured Vaults    |           | Sherlock           | No valid findings for all participants [Report](https://audits.sherlock.xyz/contests/1222) |
| 2026 (Jan) | FlyingTulip                      | Perpetual Futures |           | Sherlock           | No valid findings for all participants [Report](https://audits.sherlock.xyz/contests/1223) |
| 2025 (Dec) | Certora Capture The Funds        | CTF               | 7th       | Certora            | [Report](https://ctf.certora.com/)  |
